...
from gestureVolumeControl import volume
...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        # self.image_info_1 = customtkinter.CTkImage(master=self.my_img)
    ...
    def play(self):
        flag = False
        if self.button_1 == "Button pressed":
            flag = True
        return volume()
